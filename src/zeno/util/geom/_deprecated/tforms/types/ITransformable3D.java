...
import zeno.util.geom._deprecated.tforms.types.movement.IVantage3D;
import zeno.util.geom._deprecated.tforms.types.scale.IScalable3D;
import zeno.util.geom._deprecated.tools.IBounds3D;
