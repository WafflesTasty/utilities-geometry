package zeno.util.geom._deprecated.tools;

import java.awt.Point;

import zeno.util.algebra.tensors.vectors.fixed.Vector2;
import zeno.util.geom._deprecated.geometry.types.IGeometry2D;
import zeno.util.geom._deprecated.tools.iterators.PerimeterIterator;
import zeno.util.geom._deprecated.tools.iterators.SurfaceIterator;
