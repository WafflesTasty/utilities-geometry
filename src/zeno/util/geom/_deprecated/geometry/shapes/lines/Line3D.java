package zeno.util.geom._deprecated.geometry.shapes.lines;

import zeno.util.algebra.tensors.vectors.fixed.Vector3;
import zeno.util.geom._deprecated.geometry.shapes.solids.Cuboid;
import zeno.util.geom._deprecated.geometry.types.IGeometry3D;
